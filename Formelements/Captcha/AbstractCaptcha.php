...
abstract class AbstractCaptcha extends Tag
{
    ...
    protected function setColor(string $color): array
    {
        ...
        // keep at most the first 3 values (R, G, B) - if fewer are present,
        // all of them are kept as-is rather than being truncated further
        $colorValues = array_slice($colorValues, 0, 3, true);
    ...
    protected function createCaptchaImageTag(string $formID): Image
    {
        ...
        $this->captchaImageTag->setAttribute(
            'src',
    ...
    /**
     * Create and output the CAPTCHA image (or equivalent markup) for the given form
     * @param string $formID
     * @return void
     */
    ...
    /**
     * Create the input field(s) needed for the user to answer/solve the CAPTCHA
     * @param string $formID
     * @return Inputfields
     */
