...
abstract class Inputfields extends Element
{
    ...
    protected string $error_msg = ''; // error message for input field
     ...
     * This only affects the fieldname inside the error message and not beside the input field
    ...
    public function ___render(): string
    {
        ...
        switch ($className) {
            ...
            default:
                ...
                // if label should be appended on radios and checkboxes - append it on multiple checkboxes and radios too
                if (($className === 'InputCheckboxMultiple') || ($className === 'InputRadioMultiple')) {
                    $this->appendLabel($this->appendLabel);
                }
                // Error message
                $errormsg = '';
                if ($this->getErrormessage()->getText()) {
     ...
     * @return void
     */
    public function setDefaultValue(string|array|null $default = null): void
    {
        if (!is_null($default)) {
            if (is_string($default)) {
                //create array out of string
                $default = func_get_args();
                //sanitize array values and set them as astring
