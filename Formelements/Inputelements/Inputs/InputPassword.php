...
{
    protected ?Field $passwordField = null; // the password field object
    protected ?Module $passwordModule = null; // the password fieldtype module
    ...
    protected function getPasswordConditions(): ?string
    {
        ...
        if (in_array('none', $requirements, true)) {
            return null;
        }
