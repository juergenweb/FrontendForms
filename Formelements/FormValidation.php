...
class FormValidation extends Wire
{
    ...
    public function thisFormSubmitted(): bool
    {
        ...
        return ($this->input->$name) && ($this->input->string($name) == $this->form->getID());
    }
    ...
    public function checkTimeDiff(array $realFormElements): bool
    {
        if (($this->form->getMinTime()) || ($this->form->getMaxTime())) {
            ...
            if ((($this->form->getMinTime()) || ($this->form->getMaxTime())) && (!$start_time)) {
                ...
                $start_time = $this->form->encryptDecrypt($start_time, 'decrypt');
     ...
     * @throws WireException
     */
    public function checkMaxAttempts(int|string|bool $log): bool
    {
