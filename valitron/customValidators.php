 ...
 * This is usefull fe if the user has to fill in the old password before he enters the new one
...
/**
 * 12) Check if the value enterd is different from another value entered as param
...
/**
 * 13) Check if the new password enterd is different the old one
