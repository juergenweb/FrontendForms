...
| [stopHoneypotRotation()](#stophoneypotrotation---stop-the-randomly-rotation-of-the-honeypot-field-on-per-form-base)  | Stop the Honeypot field from randomly position and add it fixed to the very first position of the form |
