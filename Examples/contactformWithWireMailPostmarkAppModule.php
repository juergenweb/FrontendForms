...
/*
 * Example for sending mails with WireMailPostmarkApp class
 *
 * Created by Jürgen K.
 * https://github.com/juergenweb 
 * File name: contactformWithWireMailPostmarkAppModule.php
 * Created: 04.02.2024
 */

/*
 * Demonstration of a simple contactform using the WireMailPostmarkApp module
...
$content =  '<h2>A simple working contact form using the WireMailPostmarkApp class</h2>';
