...
/*
 * Example for sending mails with WireMailPHPMailer class
 *
 * Created by Jürgen K.
 * https://github.com/juergenweb 
 * File name: contactformWithPHPMailerModule.php
 * Created: 04.02.2024
 */

/*
 * Demonstration of a simple contactform using the WireMailPHPMailer module
...
$content =  '<h2>A simple working contact form using the WireMailPHPMailer class</h2>';
...
if ($form->isValid()) {
    ...
    /** Sending the mail with the custom PHPMailer module */
    $mail = wire("modules")->get("WireMailPHPMailer"); // instantiate the WireMailPHPMailer object
    ...
    $mail->bodyHTML($body);
    $mail->sendAttachments($form);  // send attachments with my custom method and do not use the addAttachment() method from the WireMailPHPMailer class
