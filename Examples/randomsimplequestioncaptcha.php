<?php
    ...
    */
    ...
    $form->setCaptchaSuccessMsg("Answer is correct!");

    // overwrite the default error message "The answer is wrong!"
    $form->setCaptchaErrorMsg('No,no,no! That is not right!');

    // overwrite the default error message "The answer is wrong!"
    //$form->setCaptchaRequiredErrorMsg('Please fill out the security question');

    // change the global notes text
    //$form->setCaptchaNotes('Think twice before you answer!');

    // set a global description text
    //$form->setCaptchaDescription('This text is the global description!');
